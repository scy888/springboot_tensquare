...
public class ProblemController{
	...
	public Result findAll(){
		String roles = (String) request.getAttribute("user");
		if (roles==null){
	...
	/**
	 * 调用base微服务controller层面的 findById()方法
	 * @RequestMapping(value = "/{labelId}")
	 */
	@Autowired
	private LabelClient labelClient;
	@GetMapping("/findLabelById/{labelId}")
	public Result dyFindById(@PathVariable String labelId){
