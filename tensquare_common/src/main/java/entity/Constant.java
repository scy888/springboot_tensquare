...
public class Constant {
    ...
    /** 赔付结论类型 */
    public static final String CONCLUSION_TYPE_PAY="1";/** 赔付 */
    public static final String CONCLUSION_TYPE_ZERO="2";/** 零结 */
    public static final String CONCLUSION_TYPE_REJECT="3";/** 拒赔 */
    public static final String CONCLUSION_TYPE_REPORT_OFF="4";/** 报案注销 */

    /** 风险反馈值 */
    public static final String WITHOUT_RISK="0";/** 无风险 */
    public static final String FALSE_LOSS="1";/** 虚报损失 */
    public static final String INSURED_CHEAT="2";/** 保险欺诈*/
    public static final String OTHER_RISK="3";/** 其他风险 */

    /** 合议类型 */
    public static final String CONSULTATION_TYPE_REGISTER="1";/** 立案合议 */
